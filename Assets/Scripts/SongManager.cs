...
public class SongManager : MonoBehaviour
{
   ...
   float secPerBeat;
    ...
    float [] notes_space_left= { 11, 11.5f, 12.5f, 14.5f, 16, 16.5f, 17.5f, 18, 21, 22, 23, 24, 26.5f, 27, 29, 31, 32.5f, 35, 37, 39, 40.5F, 45, 49, 50, 51, 54, 59, 61.5f, 61.75f, 62.5f, 63, 64, 66, 66.75f,73.75f , 75,77.5f,79,81.75f,83.5f,83.75f,84,84.25f};
    float[] notes_space_right= { 13.5f, 14, 15, 18.5f, 19, 19.5F, 20.5f, 24.5f, 26, 27.5f, 28.5f, 29.5f, 30, 30.5f, 31, 32, 33.5F, 34, 34.5f, 34.75f, 35, 36, 36.5F, 37, 38, 39, 40, 44, 46, 49.5f, 50.5f, 52, 53, 54, 54.5f, 55, 57, 57.75f, 58.5f, 59, 61, 62.5f, 63, 65, 66.5f, 70,70.5f, 71,73,74.5f,75,78.25f,78.5f,80,80.5f,82.5f ,83   };
                                                                                                                                                                                                                                                float[] notes_space_left_multi ={43,76,81 };
                                                                                                                                                                                                                                                float[] notes_space_right_multi ={  47.5f,67,77};
